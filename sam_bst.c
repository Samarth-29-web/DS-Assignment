/***********************************************************************************
         ...
         are a particular type of container: a data structure 
         that stores "items" (such as numbers, names etc.) in memory. 
...
int main()
{
        ...
        for(int a=1;a>0;a++)
	{
		...
		switch(op)
	       ...
	       int y;
               printf("Press 1 to begin insertion:");
           scanf("%d",&y);
           if(y==1)
             {
                 scanf("%s",&k);
                ...
                printf("Process succesfully executed");
       return 0;
}
